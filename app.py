...
# ---------------- LIVE CAMERA ----------------
    ...
    if img1 and img2:
        ...
        st.image(spec_img[0], caption="Spectrogram", width=350)
        st.markdown('</div>', unsafe_allow_html=True)

        st.markdown("""
        ### 📊 Spectrogram Explanation
        This spectrogram is generated using STFT on motion differences.
        Walking → pattern | Standing → flat | Falling → spike
        """)
