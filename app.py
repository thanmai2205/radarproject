...
def image_to_spectrogram(img1, img2):
    ...
    # ✅ UPDATED → Radar-like Time-Doppler Map
...
# ---------------- LIVE CAMERA ----------------
    ...
    if img1 and img2:
        ...
        Generated using Time-Doppler analysis (STFT).
        X-axis → Time | Y-axis → Velocity | Color → Motion intensity
        Walking → periodic | Standing → flat | Falling → spike
        """)
